...
class Monoblock(nn.Module):
    ...
    def __init__(
        ...
        self.v_proj = nn.Linear(self.hidden_size, self.v_dim, bias=self.qkv_bias)
        self.g_proj = nn.Linear(self.hidden_size, self.intermediate_size, bias=False)
    ...
    def forward(
        ...
        **kwargs,
        ...
        if self.fuse_swiglu:
            o = self.swiglu_linear(g, o, self.o_proj.weight, self.o_proj.bias)
        else:
            o = self.o_proj(swiglu(g, o))
